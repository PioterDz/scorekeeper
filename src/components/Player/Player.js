...
const Player = (props) => (
    ...
    <li className="Player">
        ...
        <span className="Player__button Plus__button" onClick={() => props.onPlayerScoreChange(1)}>+</span>
        <span className="Player__button Minus__button" onClick={() => props.onPlayerScoreChange(-1)}>-</span>
